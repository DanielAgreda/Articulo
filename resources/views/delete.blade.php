...
@section('title', 'Eliminar Ciclista')
...
@section('content')
    ...
    <div id="contenido">
        <div class="registro-container">
            <h1>Formulario de Eliminacion del Ciclista</h1>
            ...
            <form id="eliminar-ciclista" action="{{ route('ciclistas.destroy') }}" method="POST">
                @csrf
                @method('DELETE')

                {{-- Campo para indicar el id del ciclista a eliminar --}}
                ...
                <button type="submit" class="registro-button" name="eliminar-ciclista">Eliminar Ciclista</button>
            </form>
        </div>
    </div>
@endsection
